...
class ElementEvaluator{
    ...
    private:
        ...
        Eigen::Matrix3d computeGradU(const Eigen::VectorXd& u_e, Eigen::Vector3d (&dN_dx)[Nne]) const; //function to compute the gradient of the displacement field at the quadrature point using the basis function gradients and the nodal displacements
