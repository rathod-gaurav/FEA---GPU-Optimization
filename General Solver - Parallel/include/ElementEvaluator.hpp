...
class ElementEvaluator{
    ...
    private:
        ...
        Eigen::Matrix3d computeGradU(const Eigen::VectorXd& u_e, double xi1, double xi2, double xi3, Eigen::Matrix3d& JacInvT) const; //function to compute the gradient of the displacement field at the quadrature point using the basis function gradients and the nodal displacements
