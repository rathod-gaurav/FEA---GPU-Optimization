...
#SBATCH --job-name=FEA_Parallel_step5b
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --time=2:00:00
#SBATCH --output=FEA5b.out
#SBATCH --error=FEA5b.err
...
# ── Step 5b: Memory bandwidth measurement ──────────────────────────────────
OMP_NUM_THREADS=16 \
OMP_MAX_ACTIVE_LEVELS=2 \
  ...
  -g MEM \
  -m \
  ./build5b/main 2>&1 | tee likwid_mem.log